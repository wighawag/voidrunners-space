// from https://gist.github.com/0beqz/e69378b278e5c336afe0c7ae9b4ed86c
...
export default class MeshReflectorMaterial extends MeshStandardMaterial {
  ...
  protected parent: Mesh;

  protected hasBlur: boolean;
  protected reflectorPlane: Plane;
  protected normal: Vector3;
  protected reflectorWorldPosition: Vector3;
  protected cameraWorldPosition: Vector3;
  protected rotationMatrix: Matrix4;
  protected lookAtPosition: Vector3;
  protected clipPlane: Vector4;
  protected view: Vector3;
  protected target: Vector3;
  protected q: Vector4;
  protected textureMatrix: Matrix4;
  protected virtualCamera: PerspectiveCamera;
  protected reflectorOffset: number;
  protected planeNormal: Vector3;
  protected reflectorProps: any; // TODO

  protected fbo1: any; // TODO
  protected fbo2: any; // TODO
  protected kawaseBlurPass: KawaseBlurPass;
  ...
  onBeforeCompile(shader: Shader, renderer: WebGLRenderer) {
    ...
    shader.fragmentShader = shader.fragmentShader.replace(
      ...
      /* glsl */ `
          ...
          diffuseColor.rgb = diffuseColor.rgb * 0.2 * ((1.0 - min(1.0, mirror)) + newMerge.rgb * mixStrength);
          `,
    );
  }
}
