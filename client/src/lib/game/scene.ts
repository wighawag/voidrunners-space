...
export function createScene(): {
  ...
  directionalLight.position.set(-140, 140, 0);
  ...
  let backGrid;
  backGrid = new GridHelper(42, 60, new Color(0x7feb7f), new Color(0x7feb7f));
  backGrid.position.z = 21;
  backGrid.position.y = 21;
  backGrid.rotation.x = Math.PI / 2;
  (backGrid.material as Material).opacity = 0.1;
  ...
  scene.add(backGrid);
  backGrid = new GridHelper(42, 60, new Color(0x7feb7f), new Color(0x7feb7f));
  backGrid.position.x = 0;
  backGrid.position.y = 42;
  (backGrid.material as Material).opacity = 0.1;
  (backGrid.material as Material).transparent = true;
  scene.add(backGrid);
  ...
  //   .setPath('assets/cube/skybox/milkyway/')
  //   .load(
  ...
  new CubeTextureLoader().setPath('assets/cube/skybox/space/').load(
    [
      'front-flipped.png', // 'right-flipped.png',
      'back-flipped.png', // 'left.png',
      'top.png',
      'bottom.png',
      'right-flipped.png', // 'back-flipped.png',
      'left.png', //'front-flipped.png',
    ],
    (cubeTexture) => {
      scene.background = cubeTexture;
    },
